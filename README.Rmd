...
construction of a conservative hypothesis test of a statistically estimable
target parameter that controls the standard error in a manner that reduces the
false discovery rate or the family-wise error rate [@hejazi2018+supervised].
Utilities are also provided for performing clustering through _supervised
distance matrices_, using the EIF-based estimates to draw out the underlying
contributions of individual biomarkers to the target parameter of interest
